...
import {imageSVGTypes} from "../../utils/constants";

import {ReactComponent as LocationSVG} from './formInfoIcons/location.svg';
import {ReactComponent as MailSVG} from './formInfoIcons/mail.svg';
import {ReactComponent as PhoneSVG} from './formInfoIcons/phone.svg';

import {ReactComponent as PencilCaseSVG} from './skills/010-pencil case.svg';
import {ReactComponent as PlotterSVG} from './skills/012-plotter.svg';
import {ReactComponent as PaperSVG} from './skills/016-paper.svg';
import {ReactComponent as KeyboardSVG} from './skills/017-keyboard.svg';
import {ReactComponent as PaperRollSVG} from './skills/016-paper.svg';
import {ReactComponent as BriefcaseSVG} from './skills/020-briefcase.svg';
import {ReactComponent as PenSVG} from './skills/022-pen.svg';
import {ReactComponent as KeyboardBlueSVG} from './skills/031-keyboard.svg';
import {ReactComponent as MouseSVG} from './skills/037-mouse.svg';
...
export const Image = ({type, className}) => {
    ...
    switch(type) {
        ...
        //skills
        case skills.pencilCaseSVG: {
            return <PencilCaseSVG />
        }
        case skills.plotterSVG: {
            return <PlotterSVG />
        }
        case skills.paperSVG: {
            return <PaperSVG />
        }
        case skills.keyboardSVG: {
            return <KeyboardSVG />
        }
        case skills.paperRollSVG: {
            return <PaperRollSVG />
        }
        case skills.briefcaseSVG: {
            return <BriefcaseSVG />
        }
        case skills.penSVG: {
            return <PenSVG />
        }
        case skills.keyboardBlueSVG: {
            return <KeyboardBlueSVG />
        }
        case skills.mouseSVG: {
            return <MouseSVG />
        }
        case skills.hammerSVG: {
            return <HammerSVG />
        }
        case skills.cdSVG: {
            return <CdSVG />
        ...
        case pngImages.mainBack: {
            return <img
                src={mainBack}
                alt={pngImages.mainBack}
                className={className}
            />
        }
        case pngImages.title: {
            return <img
                src={title}
                alt={pngImages.title}
                className={className}
        ...
        case pngImages.portImg: {
            return <img
                src={portImg}
                alt={pngImages.portImg}
                className={className}
            />
        }
